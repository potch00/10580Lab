...
st.caption("도서관 규정에 기반하여 정확한 정보를 안내해 드립니다.")
...
if prompt := st.chat_input("도서관 규정에 대해 물어보세요! (예: 학부생 대출 권수?)"):
    ...
    try:
        ...
        with st.chat_message("assistant"):
            system_instruction = (
                "당신은 국립부경대학교 도서관의 친절한 안내원 AI입니다. "
                "반드시 아래 제공된 [도서관 규정 및 이용 안내] 내용을 바탕으로만 정확하게 답변하세요. "
                "규정에 없는 내용은 잘 모른다고 정중히 답변하세요.\n\n"
                f"{LIBRARY_REGULATION}"
            )
